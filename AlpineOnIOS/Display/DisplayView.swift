...
// MARK: - Shared Metal Coordinator

class DisplayCoordinator: NSObject, MTKViewDelegate {
    ...
    func mapToFramebuffer(point: CGPoint, viewSize: CGSize) -> CGPoint {
...
struct DisplayView: UIViewRepresentable {
    ...
    func makeUIView(context: Context) -> MTKView {
        ...
        let tap = UITapGestureRecognizer(target: context.coordinator,
                                          action: #selector(DisplayCoordinatorIOS.handleTap(_:)))
        view.addGestureRecognizer(tap)

        let pan = UIPanGestureRecognizer(target: context.coordinator,
                                          action: #selector(DisplayCoordinatorIOS.handlePan(_:)))
    ...
    func makeCoordinator() -> DisplayCoordinatorIOS {
        DisplayCoordinatorIOS()
    }
}

class DisplayCoordinatorIOS: DisplayCoordinator {
